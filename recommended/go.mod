...
require (
	...
	github.com/hbstack/blog/modules/heading-sign v0.1.17 // indirect
	...
	github.com/hbstack/header/modules/language-picker v0.1.19 // indirect
	...
	github.com/hugomods/simple-icons v9.17.0+incompatible // indirect
