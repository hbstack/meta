...
require (
	...
	github.com/hbstack/meta/docs v0.2.2 // indirect
	github.com/hbstack/meta/standard v0.2.1 // indirect
	...
	github.com/hugomods/simple-icons v9.1.0+incompatible // indirect
